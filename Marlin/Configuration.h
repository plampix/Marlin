...
#define CUSTOM_MACHINE_NAME "E3Blue"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 6.22f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.3656f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0466f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0738f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  // PEI
	// M303 E-1 C8 S75 U1
  #define DEFAULT_BED_KP 90.49
  #define DEFAULT_BED_KI 17.53
  #define DEFAULT_BED_KD 311.34
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (248), (Y_MIN_POS + 1), 5 }
