...
#define STRING_CONFIG_H_AUTHOR "Peter Palm" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3Orange"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.42f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2459f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0801f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0992f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  // PEI
  // M303 E-1 C8 S60 U1
  #define DEFAULT_bedKp 172.27
  #define DEFAULT_bedKi 33.92
  #define DEFAULT_bedKd 583.30
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 30, 12 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 2000, 2000, 100, 50 } // ...or, set your own edit limits
#endif
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3500, 3500, 200, 2500 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_Z_HOP       2.0        // (mm) Z raise between tramming points
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (247), (Y_MIN_POS + 1), 5 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { { 248, 30, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 230, 60, (Z_MIN_POS + 1) } }
    ...
    #define NOZZLE_CLEAN_CIRCLE_MIDDLE NOZZLE_CLEAN_END_POINT // Middle point of circle
  #endif
