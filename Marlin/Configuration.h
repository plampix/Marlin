...
#define STRING_CONFIG_H_AUTHOR "Peter Palm" // Original author or contributor.
...
#define PIDTEMPBED
  ...
  // PEI
  // M303 E-1 C8 S60 U1
  #define DEFAULT_BED_KP 172.27
  #define DEFAULT_BED_KI 33.92
  #define DEFAULT_BED_KD 583.30
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, 0, 0 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
